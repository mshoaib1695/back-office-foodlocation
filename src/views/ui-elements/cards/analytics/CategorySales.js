...
class ClientRetention extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps?.topSalesProductofMonth?.length && nextProps?.topSalesProductofMonth?.length) {
      tempState.options.xaxis.categories = nextProps.topSalesProductofMonth.map((item, i) => item[i] = item.productCatName)
      let dataTemp = nextProps.topSalesProductofMonth.map((item, i) => item[i] = item.totalSales)

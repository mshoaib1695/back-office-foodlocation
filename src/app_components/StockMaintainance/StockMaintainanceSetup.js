        ...
        <div className="data-list-header d-flex justify-content-between flex-wrap">
            <div className="actions-left d-flex flex-wrap">
                ...
                <Button
                    ...
                    color="primary"
                    onClick={() => {
                        history.push("/dashboard/createstockmaintainance")
                    }}
                    outline>
                    <Plus size={15} />
    ...
    render() {
        ...
        const columns = [
                ...
                cell: row => (
                    <p title={row.documentNo} className="text-truncate text-bold-500 mb-0"
                        onClick={() => {
                            ...
                            history.push("/dashboard/updatestockmaintainance")
                        }}
                    >
                        {row.documentNo}
                    </p>
            ...
            },
            {
                ...
                minWidth: "60px",
                cell: row => (
                    <p title={row.maintDate} className="text-truncate text-bold-500 mb-0">
                        {row.maintDate}
                    </p>
                )
            },

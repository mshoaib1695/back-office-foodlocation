...
import StockMaintainanceLines from '../StockMaintainanceLines/index'
class Accordion extends React.Component {
  ...
  render() {
    const collapseItems = [
      {
        id: 1,
        title: "Stock Maintainance Lines",
        content: [<StockMaintainanceLines stockmaintainanceId={this.props.stockmaintainanceId} />]
      },

...
function CreateProduct() {
    ...
    const [screenUpdate, setScreenUpdate] = useState(useSelector(state => state.updatescreens.screenUpdate))
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Update Screen</CardTitle>
            </CardHeader>
            <CardBody>
                <Formik
                    initialValues={{
                        name: screenUpdate.name,
                        nameAr: screenUpdate.nameAr,
                        url: screenUpdate.url,
                        description: screenUpdate.description,
                        screenGroup: screenUpdate.screenGroup
                    }}

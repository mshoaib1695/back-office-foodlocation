        ...
        <Card>
            <CardHeader>
                ...
                <Button.Ripple
                    ...
                    type="submit"
                    className="mr-1 mb-1"
                    onClick={e => history.push("/dashboard/createproductcategory")}
                >
                    Create Product Categoy
                  </Button.Ripple>
            </CardHeader>
            <CardBody>
                <ReactTable
                            ...
                            columns: [
                                ...
                                },
                                {
                                    ...
                                    Cell: (row) => (
                                        <p className="gridBtn"
                                            onClick={() => {
                                                dispatch(prodCatgryUpdate({ ...row.original }))
                                                history.push('/dashboard/updateproductcategory')
                                            }}>
                                            {row.original.name}
                                        </p>
                                    )

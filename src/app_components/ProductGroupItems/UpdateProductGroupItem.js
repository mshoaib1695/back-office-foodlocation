...
function CreateProductOffer(props) {
    ...
    const productGroupItem = useSelector(state => state.updatescreens.productGroupItem)    
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Update Product Group Item</CardTitle>
            </CardHeader>
            <CardBody>
                <Formik
                    initialValues={{
                        groupItem: productGroupItem.groupItem
                    }}

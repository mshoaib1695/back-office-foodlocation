...
import { create, deleteapi } from '../../API_Helpers/api'
...
function CreateCoupon() {
    ...
    const coupon = useSelector(state => state.updatescreens.coupon)
            ...
            <CardBody>
                <Formik
                    initialValues={{
                        ...
                        discountPtg: coupon.discountPtg,

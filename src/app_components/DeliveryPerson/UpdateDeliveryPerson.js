...
function CreateProduct() {
    ...
    const [deliverPerson, setDeliverPerson] = useState(useSelector(state => state.updatescreens.deliveryPerson))
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Update DeliveryPerson</CardTitle>
            </CardHeader>
            <CardBody>
                <Formik
                    initialValues={{
                        name: deliverPerson.name,
                        email: deliverPerson.email,
                        phoneNo: deliverPerson.phoneNo,
                    }}

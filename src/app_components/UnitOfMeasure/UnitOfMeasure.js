...
import { uomUpdate } from '../../redux/actions/updatescreens/role'
        ...
        <Card>
            <CardHeader>
                ...
                <Button.Ripple
                    ...
                    type="submit"
                    className="mr-1 mb-1"
                    onClick={e => history.push("/dashboard/createunitofmeasure")}
                >
                            ...
                            columns: [
                                {
                                    ...
                                    Cell: (row) => (
                                        <p className="gridBtn"
                                            onClick={() => {
                                                dispatch(uomUpdate({ ...row.original }))
                                                history.push('/dashboard/updateunitofmeasure')
                                            }}>
                                            {row.original.name}
                                        </p>
                                    )

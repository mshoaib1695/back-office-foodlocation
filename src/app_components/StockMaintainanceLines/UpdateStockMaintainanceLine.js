...
function CreateProductOffer(props) {
    ...
    const [stockMaintananceLine, setStockMaintananceLine] = useState(useSelector(state => state.updatescreens.stockMaintananceLine))
    ...
    const movementID = () => {
        let payload = {
            data:{
                ...
                id: stockMaintananceLine.id,
            },
            apiname:"stockMaintLineByID",
        ...
        getList(payload)
            .then(res => { message(res)
                ...
                if(res.data.success){
                    setStockMaintananceLine(res.data.object)
                }
        })
    }
    ...
    return (
        <Card>
            ...
            <CardBody>
                <Formik
                    initialValues={{
                        qty: stockMaintananceLine.qty,
                        product: stockMaintananceLine.product,
                    }}
                        ...
                        <Form>
                            <Row>
                                <Col md="6" sm="12">
                                    ...
                                    <FormGroup className="form-label-group">
                                        <p>Line No.</p>
                                        <p>{stockMaintananceLine.lineno}</p>
                                    </FormGroup>
                                    </FormGroup>
                                    <FormGroup className="form-label-group">
                                        <Field

...
function SalesInvoiceReport(props) {
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle style={{ textAlign: "center", width: '100%' }}>Tax  Report</CardTitle>
            </CardHeader>
            <CardBody>
                <>
                    <Row>
                        ...
                        <Col md="12" sm="12">
                            {
                                loading ?
                                    <a
                                        ...
                                        href={`${api_url1}reports/frameset?__report=tax_report.rptdesign&__title=Tax_Report&__showtitle=false&client_id=${client.clientId}&from=${fromDate}&to=${toDate}`}
                                        style={
                                            {

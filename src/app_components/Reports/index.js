    ...
    <Row>
                    ...
                    <Col md="12" sm="12">
                      ...
                      <div className="d-inline-block mr-1">
                        <Radio
                          ...
                          color="primary"
                          checked={
                            reportType == "productTaxPdfReport" ? true : false
                          }
                        ...
                        <Radio
                          ...
                          checked={
                            reportType == "productTaxDetailPdfReport"
                              ? true
                              : false
                          }
                          name="themeMode"
                          onChange={(v) =>
                            setReportType("productTaxDetailPdfReport")
                          }
                          onClick={(v) =>
                            setReportType("productTaxDetailPdfReport")
                          }
      ...
      <Col md="6" sm="12">
        <Card>
          <CardHeader>
            <CardTitle style={{ textAlign: "center", width: "100%" }}>
              Purchase Operations on Product Reports
            </CardTitle>
          </CardHeader>
          <CardBody>
            <>
      ...
      <Col md="6" sm="12">
        <SalesInvoiceReportWithoutFilters />
      </Col>
      <Col md="6" sm="12">
        <ProductSalesReport />
      </Col>

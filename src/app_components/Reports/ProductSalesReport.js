...
function SalesInvoiceReport() {
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle style={{ textAlign: "center", width: '100%' }}>Product Sales Report</CardTitle>
            </CardHeader>
            <CardBody>
                <>
                        ...
                        <Col md="12" sm="12">
                            {
                                loading ?
                                    ...
                                    // customer, product, toDate, fromDate, min_order_value, cost_added_value
                                        ...
                                        href={`${api_url1}reports/frameset?__report=product_sales_report.rptdesign&__title=Products_sales_Report&__showtitle=false&client_id=${client.clientId}&from=${fromDate}&to=${toDate}&branch_id=${product ? product : ""}`}
                                        style={
                                            {

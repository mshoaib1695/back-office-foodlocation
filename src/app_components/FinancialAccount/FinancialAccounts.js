...
import { faccountUpdate } from '../../redux/actions/updatescreens/role'
...
function PaymentReason() {
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Financial Account Setup</CardTitle>
                <Button.Ripple
                    color="primary"
                    type="submit"
                    className="mr-1 mb-1"
                    onClick={e => history.push("/dashboard/createfaccount")}
                >
                    Create Account
                  </Button.Ripple>
            </CardHeader>
                            ...
                            columns: [
                                {
                                    ...
                                    Cell: (row) => (
                                        <p className="gridBtn"
                                            onClick={() => {
                                                dispatch(faccountUpdate({ ...row.original }))
                                                history.push('/dashboard/updatefaccount')
                                            }}>
                                            {row.original.name}
                                        </p>
                                    )

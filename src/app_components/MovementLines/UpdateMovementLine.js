...
function CreateProductOffer(props) {
  ...
  const movementLine = useSelector((state) => state.updatescreens.movementLine);
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Update Movement Line</CardTitle>
      </CardHeader>
      <CardBody>
        <Formik
          initialValues={{
            qty: movementLine.qty,
            product: movementLine.product,
            uom: movementLine.uom,
            srcWarehouse: movementLine.srcWarehouse,
            destWarehouse: movementLine.destWarehouse,
          }}

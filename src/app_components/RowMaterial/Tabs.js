...
import ProductLowLimit from '../ProductLowLimit/index'
...
class Accordion extends React.Component {
  ...
  render() {
    const collapseItems = [
      {
        id: 1,
        title: "Product Warehouse Low Limit",
        content: [<ProductLowLimit rowMatId={this.props.rowMatId} />]
      },
      {
        id: 2,
        title: "Product Price",
        content: [<ProductPrice rowMatId={this.props.rowMatId} />]
      },
    ]
    ...
    const accordionItems = collapseItems.map(collapseItem => {
        ...
        return (
         (
           !this.props.showLowLimit && collapseItem.id == "1" ||
           !this.props.isDirectProduct && collapseItem.id == 2 
         ) ? "" : <Card
            key={collapseItem.id}

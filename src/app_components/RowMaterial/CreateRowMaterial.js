...
function CreateRole() {
    ...
    const getProdCatList = () => {
        ...
        getList(payload)
            .then(res => {
                ...
                setRowCatgry(res.data.filter(i => i.name.toLowerCase() == "row_material" || i.name.toLowerCase() == "row material")[0])
    ...
    const submitHandler = (values) => {
        ...
        data.append('isPurchasedProduct', true);
        ...
        data.append('isCheckLowLimit', values.isCheckLowLimit);
        data.append('isDirectProduct', values.isDirectProduct);
        ...
        if (values.isDirectProduct) {
            ...
            if (rowCatgry.id) {
                ...
                toast.error("Please create a row material category before creating row materials.")
            }
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Create Row Material</CardTitle>
            </CardHeader>
            <CardBody>
                <Formik
                    initialValues={{

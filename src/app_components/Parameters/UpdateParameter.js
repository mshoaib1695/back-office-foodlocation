...
import { parametersList, updateParameters } from '../../API_Helpers/parameters'
...
function UpdateParameter() {
    const parameter = useSelector(state => state.updatescreens.parameter)    
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Update Parameter</CardTitle>
            </CardHeader>
            <CardBody>
                <Formik
                    initialValues={{
                        ...
                        type: parameter.paraType,
                        isParent: parameter.isParent,

...
function ProductPrice(props) {
    ...
    const productPrice = useSelector(state => state.updatescreens.productPrice)    
            ...
            <CardBody>
                <Formik
                    initialValues={{
                        ...
                        collectPoints: productPrice.collectPoints,
                        uom: productPrice.uom,
                        salesPrice: productPrice.salesPrice,
                        calculatedrpice: productPrice.salesPriceTax,
